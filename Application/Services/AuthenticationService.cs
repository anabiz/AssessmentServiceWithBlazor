...
namespace Application.Services.V1
{
    internal class AuthenticationService //: IAuthenticationService
    {
        ...
        //    if (!user.IsActive)
        //        throw new RestException(HttpStatusCode.Unauthorized, "User is disabled");

        //    if (!user.IsActive || !user.EmailConfirmed || !user.Verified)
        //        throw new RestException(HttpStatusCode.NotFound, "Wrong email or password");
        ...
        //    var tokenResponse = Authenticate(user, student, roles);
        ...
        //private TokenReturnHelper Authenticate(User user, Student student, IList<string> roles)
        //{
        ...
        //        new Claim(ClaimTypeHelper.StudentId, student?.Id.ToString() ?? ""),
        //    };
